               ...
               <div className="row">
                    <div className="col-sm-9">
                        <div className="input-group">
                            ...
                            <input type="text" ref="name" className="form-control" placeholder="" maxLength="128" defaultValue={this.props.state.team.domain} autoFocus={true} onFocus={this.handleFocus}/>
                        </div>
                    </div>
                </div>
                { name_error }
