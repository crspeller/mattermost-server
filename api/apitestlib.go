...
func (me *TestHelper) InitSystemAdmin() *TestHelper {
	...
	UpdateUserRoles(c, me.SystemAdminUser, model.R_SYSTEM_ADMIN.Id)
...
func UpdateUserToTeamAdmin(user *model.User, team *model.Team) {
	...
	tm := &model.TeamMember{TeamId: team.Id, UserId: user.Id, Roles: model.R_TEAM_USER.Id + " " + model.R_TEAM_ADMIN.Id}
