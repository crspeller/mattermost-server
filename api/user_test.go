...
func TestCreateUser(t *testing.T) {
	...
	team := model.Team{Name: "Name", URLId: "z-z-" + model.NewId() + "a", Email: "test@nowhere.com", Type: model.TEAM_OPEN}
...
func TestCreateUserAllowedDomains(t *testing.T) {
	...
	team := model.Team{Name: "Name", URLId: "z-z-" + model.NewId() + "a", Email: "test@nowhere.com", Type: model.TEAM_INVITE, AllowedDomains: "spinpunch.com, @nowh.com,@hello.com"}
	rteam, _ := Client.CreateTeam(&team)
...
func TestLogin(t *testing.T) {
	...
	if result, err := Client.LoginByEmail(team.URLId, user.Email, user.Password); err != nil {
		t.Fatal(err)
	} else {
		if result.Data.(*model.User).Email != user.Email {
	...
	if _, err := Client.LoginByEmail(team.URLId, user.Email, user.Password+"invalid"); err == nil {
		t.Fatal("Invalid Password")
	}

	if _, err := Client.LoginByEmail(team.URLId, "", user.Password); err == nil {
		t.Fatal("should have failed")
	}
	...
	team2 := model.Team{Name: "Name", URLId: "z-z-" + model.NewId() + "a", Email: "test@nowhere.com", Type: model.TEAM_INVITE}
	...
	if _, err := Client.LoginByEmail(team2.URLId, ruser2.Data.(*model.User).Email, user2.Password); err != nil {
...
func TestSessions(t *testing.T) {
	...
	Client.LoginByEmailWithDevice(team.URLId, user.Email, user.Password, deviceId)
	Client.LoginByEmail(team.URLId, user.Email, user.Password)
...
func TestUserCreateImage(t *testing.T) {
	...
	Client.LoginByEmail(team.URLId, user.Email, "pwd")
...
func TestUserUpdate(t *testing.T) {
	...
	Client.LoginByEmail(team.URLId, user2.Email, "pwd")
...
func TestUserUpdatePassword(t *testing.T) {
	...
	if _, err := Client.LoginByEmail(team.URLId, user.Email, "newpwd"); err != nil {
		t.Fatal(err)
	}
...
func TestUserUpdateRoles(t *testing.T) {
	...
	team2 := &model.Team{Name: "Name", URLId: "z-z-" + model.NewId() + "a", Email: "test@nowhere.com", Type: model.TEAM_OPEN}
	...
	Client.LoginByEmail(team2.URLId, user3.Email, "pwd")
...
func TestSendPasswordReset(t *testing.T) {
	...
	data["urlId"] = ""
	if _, err := Client.SendPasswordReset(data); err == nil {
		t.Fatal("Should have errored - no urlId")
	}

	data["urlId"] = "junk"
	if _, err := Client.SendPasswordReset(data); err == nil {
		t.Fatal("Should have errored - bad urlId")
	}
}
...
func TestResetPassword(t *testing.T) {
	...
	team2 := &model.Team{Name: "Name", URLId: "z-z-" + model.NewId() + "a", Email: "test2@nowhere.com", Type: model.TEAM_OPEN}
	team2 = Client.Must(Client.CreateTeam(team2)).Data.(*model.Team)

	data["domain"] = team2.URLId
	if _, err := Client.ResetPassword(data); err == nil {
