...
func TestCreateChannel(t *testing.T) {
	...
	team2 := &model.Team{Name: "Name Team 2", URLId: "z-z-" + model.NewId() + "a", Email: "test@nowhere.com", Type: model.TEAM_OPEN}
...
func TestUpdateChannel(t *testing.T) {
	...
	Client.LoginByEmail(team.URLId, userChannelAdmin.Email, "pwd")
	...
	Client.LoginByEmail(team.URLId, userTeamAdmin.Email, "pwd")
	...
	Client.LoginByEmail(team.URLId, userStd.Email, "pwd")
...
func TestGetMoreChannel(t *testing.T) {
	...
	Client.LoginByEmail(team.URLId, user1.Email, "pwd")
...
func TestJoinChannel(t *testing.T) {
	...
	Client.LoginByEmail(team.URLId, user3.Email, "pwd")
