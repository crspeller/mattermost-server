...
Inline Image with link, alt text, and hover text: ![Build Status](https://travis-ci.org/crspeller/mattermost-server.svg?branch=master)](https://travis-ci.org/crspeller/mattermost-server)
